    ...
    init() {
        ...
        this.on('getMatchBetResults', async req => {
            ...
            const results = matches.map(match => {
                ...
                const team1 = teamMap[match.team1_ID] || {};
                const team2 = teamMap[match.team2_ID] || {};
                const betTeamWin = teamMap[bet.team_win_ID] || {};
                const teamWin = teamMap[match.team_win_ID] || {};
                return {
                    ...match,
                    team1_Name:team1.team_name,
                    team2_Name:team2.team_name,
                    team_win_ID_bet: bet.team_win_ID,
                    team_win_Name_bet: betTeamWin.team_name,
                    team_win_Name: teamWin.team_name,
                    isDraw: bet.isDraw
                };
            });
